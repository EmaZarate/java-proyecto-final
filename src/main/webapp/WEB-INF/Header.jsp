...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="productList">Matisa</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="salesList">
          	<%
      ...
      <div class="d-flex" >
		...
		<%} %>
	     <form class="d-flex" action="productSearch" method="post" role="search">
	       <input class="form-control me-2" name="searchTerm" type="search" placeholder="Buscar Producto" aria-label="Search">
